...
int main () {
	...
	import_2.get_vector_data (2, exp_freq, experimental_size);
	import_2.get_vector_data (7, exp_mag, experimental_size);
	import_2.get_vector_data (8, exp_phase, experimental_size);
